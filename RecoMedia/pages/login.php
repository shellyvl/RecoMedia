...
<body>
    ...
    <main>
            ...
            <?php if(isset($_GET['success'])): ?>
                <p style="color: #28a745; background: #d4edda; padding: 10px; border-radius: 5px; text-align: center; margin-bottom: 15px;">
                Votre compte a été créé avec succès ! Connectez-vous.
                </p>
            <?php endif; ?>
            <?php if(isset($_GET['deconnecte'])): ?>
                <p style="color: #666; background: #e2e3e5; padding: 10px; border-radius: 5px; text-align: center; margin-bottom: 15px;">
